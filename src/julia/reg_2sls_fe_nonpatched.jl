...
# -----------------------------------------------------------------------------
import Pkg;
Pkg.add(name="Vcov", version="0.4.0", preserve=Pkg.PRESERVE_ALL); # this new version has the fix
Pkg.add(name="FixedEffectModels", version="1.4.0", preserve=Pkg.PRESERVE_ALL); # this new version has the fix
